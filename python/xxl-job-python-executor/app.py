...
config = ExecutorConfig(
    xxl_admin_baseurl=os.getenv("XXL_JOB_ADMIN_ADDRESS", "http://127.0.0.1:8070/xxl-job-admin/api/"),
    executor_app_name=os.getenv("XXL_JOB_EXECUTOR_APPNAME", "python-general-executor"),
    ...
    executor_url=os.getenv("XXL_JOB_EXECUTOR_URL", "http://127.0.0.1:9999/"),
